...
@router.post("/")
async def post_update(*,update: UpdatePublic, session: Session = Depends(get_session)) -> Status:
    """Post update"""
...
async def get_update(*, update_id: str, session: Session = Depends(get_session)) -> UpdatePublic:
    """Get update"""
